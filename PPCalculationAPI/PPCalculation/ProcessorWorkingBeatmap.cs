...
namespace PPCalculationAPI.PPCalculation
{
    ...
    public class ProcessorWorkingBeatmap : WorkingBeatmap
    {
            ...
            : base(beatmap.BeatmapInfo, null)
        {
            ...
            beatmap.BeatmapInfo.Ruleset = RulesetUtils.GetRuleset(beatmap.BeatmapInfo.Ruleset.OnlineID).RulesetInfo;
        ...
        public static ProcessorWorkingBeatmap FromFileOrId(string fileOrId)
        {
            ...
            if (!File.Exists(cachePath))
            {
                ...
                new FileWebRequest(cachePath, $"https://osu.ppy.sh/osu/{beatmapId}").Perform();
            }
